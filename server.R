...
#### NEXT: CHECK LENGTH OF SEQUENCE (INPUT SEQ IF NO BsaI SITES OR SUBSTITUTED SEQ IF THERE ARE BsaI SITES IN ORIGINAL SEQ)
  ### NUMBER OF FRAGMENTS: 1 (0-288), 2 (291-580), 3 (581-870), 4(871-1160), 5(1161-1450)
